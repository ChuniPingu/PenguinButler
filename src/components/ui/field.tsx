...
function FieldTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="field-label"
      className={cn(
        "flex w-fit items-center gap-2 text-xs/relaxed select-none group-data-[disabled=true]/field:opacity-50",
        className,
      )}
      {...props}
    />
...
function FieldDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
      ...
      className={cn(
        "text-left text-xs/relaxed leading-normal font-normal text-muted-foreground select-none group-has-data-horizontal/field:text-balance [[data-variant=legend]+&]:-mt-1.5",
